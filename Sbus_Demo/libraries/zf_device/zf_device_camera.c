...
// @param       image_size      图像的大小
// @return      void
// Sample usage:                camera_init(OV7725_SIZE);
//-------------------------------------------------------------------------------------------------------------------
void camera_init (const uint32 image_size)
{
    switch(camera_type)
    {
        ...
        case CAMERA_BIN_UART:                                                   // UART 小钻风
            ...
            dma_init_camera(                                                    // 摄像头 DMA 关联初始化
                ...
                image_size,                                                     // 图像大小
                (uint32)OV7725_DATA_ADD,                                        // 指定数据输入的外设地址
                (uint32)&ov7725_image_binary[0][0]);                            // 指定数据存放首地址
        ...
        case CAMERA_GRAYSCALE:                                                  // 总钻风
            ...
            dma_init_camera(                                                    // 摄像头 DMA 关联初始化
                ...
                image_size,                                                     // 图像大小
                (uint32)MT9V03X_DATA_ADD,                                       // 指定数据输入的外设地址
                (uint32)&mt9v03x_image[0][0]);                                  // 指定数据存放首地址
            if(MT9V03X_W > 188)
        ...
        case CAMERA_COLOR:                                                      // 凌瞳
            ...
            dma_init_camera(                                                    // 摄像头 DMA 关联初始化
                ...
                image_size,                                                     // 图像大小
                (uint32)SCC8660_DATA_ADD,                                       // 指定数据输入的外设地址
                (uint32)&scc8660_image[0][0]);                                  // 指定数据存放首地址
