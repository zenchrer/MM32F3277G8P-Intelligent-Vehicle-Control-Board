...
#define RC_UART_INDEX       (UART_3)       // 无线串口对应使用的串口号
#define RC_UART_BUAD_RATE   (100000)       // 无线串口对应使用的串口波特率
#define RC_UART_TX_PIN      (UART3_TX_B10) // 无线串口对应模块的 TX 要接到单片机的 RX
#define RC_UART_RX_PIN      (UART3_RX_B11) // 无线串口对应模块的 RX 要接到单片机的 TX
