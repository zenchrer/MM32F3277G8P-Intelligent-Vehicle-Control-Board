...
#define IPS114_SCL_PIN                  (A5)                                    // 软件 SPI SCK 引脚
#define IPS114_SDA_PIN                  (A7)                                    // 软件 SPI MOSI 引脚
//====================================================软件 SPI 驱动====================================================
#else
//====================================================硬件 SPI 驱动====================================================
#define IPS114_SPI_SPEED                (system_clock / 4)                      // 硬件 SPI 速率 这里设置为系统时钟二分频
#define IPS114_SPI                      (SPI_1)                                 // 硬件 SPI 号
#define IPS114_SCL_PIN                  (SPI1_SCK_A5)                           // 硬件 SPI SCK 引脚
#define IPS114_SDA_PIN                  (SPI1_MOSI_A7)                          // 硬件 SPI MOSI 引脚
//====================================================硬件 SPI 驱动====================================================
#endif

#define IPS114_RST_PIN                  (A6 )                                   // 液晶复位引脚定义
#define IPS114_DC_PIN                   (D0 )                                   // 液晶命令位引脚定义
#define IPS114_CS_PIN                   (A4 )                                   // CS 片选引脚
#define IPS114_BLK_PIN                  (D1 )                                   // 液晶背光引脚定义
