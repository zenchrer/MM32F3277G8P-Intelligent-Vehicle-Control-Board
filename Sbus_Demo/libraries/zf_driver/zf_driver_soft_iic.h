...
void        soft_iic_write_8bit_arrray      (soft_iic_info_struct *soft_iic_obj, const uint8 *data, uint32 len);

void        soft_iic_write_16bit            (soft_iic_info_struct *soft_iic_obj, const uint16 data);
void        soft_iic_write_16bit_arrray     (soft_iic_info_struct *soft_iic_obj, const uint16 *data, uint32 len);
