...
#define WRIELESS_UART_INDEX         (UART_6)                                    // 无线串口对应使用的串口号
#define WRIELESS_UART_BUAD_RATE     (115200)                                    // 无线串口对应使用的串口波特率
#define WRIELESS_UART_TX_PIN        (UART6_RX_C7)                               // 无线串口对应模块的 TX 要接到单片机的 RX
#define WRIELESS_UART_RX_PIN        (UART6_TX_C6)                               // 无线串口对应模块的 RX 要接到单片机的 TX
#define WRIELESS_UART_RTS_PIN       (C13)                                       // 无线串口对应模块的 RTS 引脚
