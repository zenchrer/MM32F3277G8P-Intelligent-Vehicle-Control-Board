...
#define OLED_D0_PIN                     (A5)                                    // 软件 SPI SCK 引脚
#define OLED_D1_PIN                     (A7)                                    // 软件 SPI MOSI 引脚
//====================================================软件 SPI 驱动====================================================
#else
//====================================================硬件 SPI 驱动====================================================
#define OLED_SPI_SPEED                  (system_clock / 2)                      // 硬件 SPI 速率
#define OLED_SPI                        (SPI_1)                                 // 硬件 SPI 号
#define OLED_D0_PIN                     (SPI1_SCK_A5)                           // 硬件 SPI SCK 引脚
#define OLED_D1_PIN                     (SPI1_MOSI_A7)                          // 硬件 SPI MOSI 引脚
//====================================================硬件 SPI 驱动====================================================
#endif

#define OLED_RES_PIN                    (A6 )                                   // 液晶复位引脚定义
#define OLED_DC_PIN                     (D0 )                                   // 液晶命令位引脚定义
#define OLED_CS_PIN                     (A4 )                                   // CS 片选引脚
