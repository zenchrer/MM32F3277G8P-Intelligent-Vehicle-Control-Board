...
#define TFT180_SCL_PIN                  (A5 )                                   // 软件 SPI SCK 引脚
#define TFT180_SDA_PIN                  (A7 )                                   // 软件 SPI MOSI 引脚
//====================================================软件 SPI 驱动====================================================
#else
//====================================================硬件 SPI 驱动====================================================
#define TFT180_SPI_SPEED                (system_clock / 3)                      // 硬件 SPI 速率
#define TFT180_SPI                      (SPI_1)                                 // 硬件 SPI 号
#define TFT180_SCL_PIN                  (SPI1_SCK_A5)                           // 硬件 SPI SCK 引脚
#define TFT180_SDA_PIN                  (SPI1_MOSI_A7)                          // 硬件 SPI MOSI 引脚
//====================================================硬件 SPI 驱动====================================================
#endif
